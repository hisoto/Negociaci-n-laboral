...
file.copy(name_centrales, file.path(ruta_externa, "graphs", basename(name_centrales)), overwrite = TRUE)
ggsave(sub("\\.png$", ".svg", name_centrales), plot = last_plot(), width = 50, height = 25, units = "cm")
