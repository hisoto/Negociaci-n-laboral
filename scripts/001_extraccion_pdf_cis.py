# ── 001_extraccion_pdf_cis.py ────────────────────────────────────────────────
# Extrae Cuadros 1-4 de las Tarjetas Semanales CIS (183 PDFs, 2020-2026)
# desde inputs/cis_pdf/ y los acumula en 4 CSVs históricos en inputs/cis_csv/.
#
# Uso:
#   python scripts/001_extraccion_pdf_cis.py              # extracción completa
#   python scripts/001_extraccion_pdf_cis.py --incremental # solo PDFs nuevos
...
PDF_DIR      = PROJECT_ROOT / "inputs" / "cis_pdf"
OUTPUT_DIR   = PROJECT_ROOT / "inputs" / "cis_csv"
